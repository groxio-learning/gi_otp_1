defmodule Bot do
  ...
  def draw(%{orientation: :east, point: point}) do
  ...
  def draw(%{orientation: :west, point: point}) do
  ...
  def draw(%{orientation: :north, point: point}) do
  ...
  def draw(%{orientation: :south, point: point}) do
    p1 = point |> locate() |> shift({0, 0})
    p2 = point |> locate() |> shift({-5, -5})
    p3 = point |> locate() |> shift({5, -5})
    ~s[<polygon
